    ...
    return (
        <footer className='Footer'>
            ...
            <div className='address-container'>
                ...
                <a className='phone-number'>Call Us: 949-833-7432</a>
            </div>
            <div className='wrap'>
                <div>
